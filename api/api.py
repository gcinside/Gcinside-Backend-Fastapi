...
api_router.include_router(google_login.router, prefix="/google", tags=["auth"])
api_router.include_router(google_callback.router, prefix="/google", tags=["auth"])

api_router.include_router(github_login.router, prefix="/github", tags=["auth"])
api_router.include_router(github_callback.router, prefix="/github", tags=["auth"])
